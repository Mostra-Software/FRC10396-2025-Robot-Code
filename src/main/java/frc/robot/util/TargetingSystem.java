...
public class TargetingSystem {
  ...
  private Transform2d leftrobotBranchScoringOffset =
      new Transform2d((0.883 / 2.0) + 0.0, -Inches.of(1.0).in(Meters), Rotation2d.fromDegrees(183));

  private Transform2d rightrobotBranchScoringOffset =
      new Transform2d((0.883 / 2.0) + 0.0, Inches.of(1.0).in(Meters), Rotation2d.fromDegrees(187));
