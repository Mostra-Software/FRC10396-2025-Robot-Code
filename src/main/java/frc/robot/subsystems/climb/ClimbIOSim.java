...
public class ClimbIOSim implements ClimbIO {
  ...
  private final ElevatorSim m_elevatorSim =
      new ElevatorSim(gearbox, ClimbConstants.motorReduction, 1, 1, 1, 1, true, 0, 0.01, 0.0);
  ...
  public void updateInputs(ClimbIOInputs inputs) {
    ...
    double rpm = (m_elevatorSim.getVelocityMetersPerSecond() / 1) / 60.;
  ...
  @Override
  public void setDegree(double height) {
    setpoint = height;
